...
\const\Acrobatics{\Acrobatics+\ProfBonus}
\const\SleightOfHand{\SleightOfHand+\ProfBonus}
...
\NameAndDesc{Shapeshift}{ \emph{\Numberstringnum{\ProfBonus} use per short or long rest.} You magically assume the shape of one of your chosen transformations. You can stay shapeshifted for \CHAmod h. \newline Known shapes: Pirate Bosun, Hobgoblin, Warhorse}
}
